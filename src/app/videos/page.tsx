...
import {
  testimonials,
  educationalVideos,
  YOUTUBE_TESTIMONIALS_PLAYLIST_URL,
  YOUTUBE_EDUCATIONAL_PLAYLIST_URL,
    ...
    <div className="min-h-screen">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* YouTube Playlists Callout */}
          <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-2xl bg-gradient-to-r from-red-50 via-rose-50 to-orange-50 border border-red-200/80 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-900">Patient Recovery Stories</h3>
                  <p className="text-xs text-gray-600">Watch real patient recovery journeys on YouTube</p>
                </div>
              </div>
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-red-600 hover:bg-red-700 text-white shadow transition-all hover:scale-[1.02] flex-shrink-0"
              >
                Stories Playlist ({testimonials.length}+)
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border border-blue-200/80 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[var(--color-clinical-600)] text-white flex items-center justify-center flex-shrink-0 shadow-md">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-gray-900">Sciatica A to Z Educational Series</h3>
                  <p className="text-xs text-gray-600">3D animations &amp; medical guides by Dr. Shahnawaz Shah</p>
                </div>
              </div>
              <a
                href={YOUTUBE_EDUCATIONAL_PLAYLIST_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-[var(--color-clinical-600)] hover:bg-[var(--color-clinical-700)] text-white shadow transition-all hover:scale-[1.02] flex-shrink-0"
              >
                Sciatica Playlist (16)
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
              </a>
