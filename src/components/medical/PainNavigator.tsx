...
type NavigatorState = "explore" | "detail" | "questionnaire" | "results";
    ...
    <div className="w-full">
      ...
      {state === "explore" && (
        <>
          ...
          <div className="max-w-md mx-auto mb-6">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search your pain area..."
          ...
          {/* Body Map or List */}
          {view === "body" ? (
            <Body3D areas={filteredAreas} selectedIds={selectedAreas.map((a) => a.id)} onSelect={selectArea} />
          ) : (
          ...
          {selectedAreas.length > 0 && (
            <div className="mt-8 p-6 rounded-xl bg-[var(--color-surface-50)] border border-[var(--color-surface-200)] max-w-3xl mx-auto animate-slide-up">
              <h3 className="text-lg font-bold text-[var(--color-text-primary)] mb-3">Selected Pain Areas</h3>
